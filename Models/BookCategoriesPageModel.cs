...
namespace Godja_Vasile_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Godja_Vasile_Lab2Context context, Book book)
        {
        ...
        public async Task UpdateBookCategories(Godja_Vasile_Lab2Context context, string[] selectedCategories, int bookId)
        {
